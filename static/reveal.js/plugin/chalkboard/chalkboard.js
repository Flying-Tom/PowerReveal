...
******************************************************************/
	...
	switch ( theme ) {
		case "whiteboard":
			background = [ 'rgba(255,255,255,0)' , path + 'img/whiteboard.png' ];
			pen = [ 'url(' + path + 'img/boardmarker.png), auto',
				'url(' + path + 'img/boardmarker.png), auto' ];
			draw = [ drawWithPen , drawWithPen ];
            color = ['rgba(255,161,20,1)', 'rgba(255,161,20,1)'];
			break;
		default:
			background = [ 'rgba(255,255,255,0)' , path + 'img/blackboard.png' ];
			pen = [ 'url(' + path + 'img/boardmarker.png), auto',
				'url(' + path + 'img/chalk.png), auto' ];
			draw = [ drawWithPen , drawWithChalk ];
			color = [ 'rgba(255,161,20,1)', 'rgba(255,161,20,0.5)' ];
	}
